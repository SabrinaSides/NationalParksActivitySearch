...
function displayWeather(responseJson){
    ...
    for(let i = 0; i < responseJson.DailyForecasts.length; i++){
        $('#weather-results').append(`
            <section>
                <div class='forecast'>
                    <div><p>High: ${responseJson.DailyForecasts[i].Temperature.Maximum.Value}&deg F</p></div>
                    <div><p>Low: ${responseJson.DailyForecasts[i].Temperature.Minimum.Value}&deg F</p></div>
